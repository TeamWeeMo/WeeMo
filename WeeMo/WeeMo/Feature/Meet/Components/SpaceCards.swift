...
#Preview("SelectedSpaceCard") {
    SelectedSpaceCard(
        space: Space(
            ...
            hasBathRoom: true,
            maxPeople: 6,
            description: "조용한 스터디룸",
            latitude: 37.5,
            longitude: 127.0,
            hashTags: []
        ),
        reservationDate: Date(),
        reservationStartHour: 14,
        reservationTotalHours: 3,
        totalHours: 3
    )
    .padding()
}

#Preview("MeetSpaceCard") {
    MeetSpaceCard(
        spaceName: "강남 스터디룸",
        address: "서울시 강남구 테헤란로 123",
        spaceImageURL: nil,
        reservationScheduleText: "2025.11.28 14:00 - 17:00",
        priceText: "10,000원"
    )
    .padding()
}
